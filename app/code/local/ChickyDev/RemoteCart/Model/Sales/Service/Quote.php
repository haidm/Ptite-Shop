<?php
class ChickyDev_RemoteCart_Model_Sales_Service_Quote extends Mage_Sales_Model_Service_Quote
{
    public function submitOrder()
    {
        $this->getQuote()->getPayment()->setMethod('checkmo');
        ...
        $quote->getBillingAddress()->setFirstname($customer->getName());
        $quote->getBillingAddress()->setLastname(' ');
        $quote->getBillingAddress()->setTelephone($customer->getTelephone());
        if ($isVirtual) {
