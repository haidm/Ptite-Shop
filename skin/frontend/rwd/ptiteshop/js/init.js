    ...
    ! function(a, b, c) {
        var d = function(a) {
            a(".background-image").each(function() {
                ...
                a(this).css("background", 'url("' + b + '")').css("opacity", "1")
            })
        };
...
! function(a, b, c, d) {
    ...
    function(a, b, c) {
        ...
        }, d.prototype.backgroundChange = function(){
            $j('#hero .background-image').prepend($j('#hero .background-image img:last'));
            $j('#hero .background-image').css('opacity', 0.3)
                .delay(500);
            $j('#hero .background-image').css('background', 'url(' + $j('#hero .background-image img:first').attr('src') + ')')
                .css('opacity', 1);
        }, d.prototype.stop = function() {
...
! function(t, e) {
    ...
    function(t, e) {
        "function" == typeof define && define.amd ? define("fizzy-ui-util/util", ["desandro-matches-selector/matches-selector"], function(i) {
            return e(t, i)
    ...
    function(t, e) {
        "use strict";
        "function" == typeof define && define.amd ? define("outlayer/outlayer", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-util/util", "./item"], function(i, n, o, s) {
            return e(t, i, n, o, s)
        }) : "object" == typeof module && module.exports ? module.exports = e(t, require("ev-emitter"), require("get-size"), require("fizzy-ui-util"), require("./item")) : t.Outlayer = e(t, t.EvEmitter, t.getSize, t.fizzyUIUtils, t.Outlayer.Item)
    ...
    function(t, e) {
        "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size", "desandro-matches-selector/matches-selector", "fizzy-ui-util/util", "isotope/js/item", "isotope/js/layout-mode", "isotope/js/layout-modes/masonry", "isotope/js/layout-modes/fit-rows", "isotope/js/layout-modes/vertical"], function(i, n, o, s, r, a) {
            return e(t, i, n, o, s, r, a)
        }) : "object" == typeof module && module.exports ? module.exports = e(t, require("outlayer"), require("get-size"), require("desandro-matches-selector"), require("fizzy-ui-util"), require("isotope/js/item"), require("isotope/js/layout-mode"), require("isotope/js/layout-modes/masonry"), require("isotope/js/layout-modes/fit-rows"), require("isotope/js/layout-modes/vertical")) : t.Isotope = e(t, t.Outlayer, t.getSize, t.matchesSelector, t.fizzyUIUtils, t.Isotope.Item, t.Isotope.LayoutMode)
    ...
    function g(b, e) {
        var f = new google.maps.LatLng(b, e),
            ...
            k = new google.maps.Marker({
                position: f,
                map: h,
                icon: "/skin/frontend/rwd/ptiteshop/images/marker.png",
...
function initVossenMaps() {
    var a = $j("#vossen-map").data("maps-api-key"),
...
function vosResize() {
    var a = $(window).width() + 0,
        b = $(window).height() + 0;
    a / b > 16 / 9 ? (player.setSize(a, a / 16 * 9), $("#vossen-youtube").css({
        left: "50%"
    })) : (player.setSize(b / 9 * 16, b), $("#vossen-youtube").css({
 ...
 */
if ($j('#twitter-feed-slider, #twitter-feed-list').length) {
    ! function(e, t) {
        "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? module.exports = t() : t()
    }(this, function() {
        function e(e) {
            if (null === w) {
                for (var t = e.length, n = 0, i = document.getElementById(a), s = "<ul>"; t > n;) s += "<li>" + e[n] + "</li>", n++;
                s += "</ul>", i.innerHTML = s
            } else w(e)
        }
        ...
        function i(e, t) {
            for (var n = [], i = new RegExp("(^| )" + t + "( |$)"), s = e.getElementsByTagName("*"), a = 0, l = s.length; l > a; a++) i.test(s[a].className) && n.push(s[a]);
            return n
        }
        ...
        var a = "",
            ...
            C = {
                fetch: function(e) {
                    if (void 0 === e.maxTweets && (e.maxTweets = 20), void 0 === e.enableLinks && (e.enableLinks = !0), void 0 === e.showUser && (e.showUser = !0), void 0 === e.showTime && (e.showTime = !0), void 0 === e.dateFunction && (e.dateFunction = "default"), void 0 === e.showRetweet && (e.showRetweet = !0), void 0 === e.customCallback && (e.customCallback = null), void 0 === e.showInteraction && (e.showInteraction = !0), void 0 === e.showImages && (e.showImages = !1), void 0 === e.linksInNewWindow && (e.linksInNewWindow = !0), void 0 === e.showPermalinks && (e.showPermalinks = !0), void 0 === e.dataOnly && (e.dataOnly = !1), c) o.push(e);
                    else {
                        c = !0, a = e.domId, l = e.maxTweets, r = e.enableLinks, m = e.showUser, d = e.showTime, h = e.showRetweet, p = e.dateFunction, w = e.customCallback, g = e.showInteraction, f = e.showImages, v = e.linksInNewWindow, T = e.showPermalinks, y = e.dataOnly;
                        var t = document.getElementsByTagName("head")[0];
                        null !== k && t.removeChild(k), k = document.createElement("script"), k.type = "text/javascript", void 0 !== e.list ? k.src = "https://syndication.twitter.com/timeline/list?callback=twitterFetcher.callback&dnt=false&list_slug=" + e.list.listSlug + "&screen_name=" + e.list.screenName + "&suppress_response_codes=true&lang=" + (e.lang || b) + "&rnd=" + Math.random() : void 0 !== e.profile ? k.src = "https://syndication.twitter.com/timeline/profile?callback=twitterFetcher.callback&dnt=false&screen_name=" + e.profile.screenName + "&suppress_response_codes=true&lang=" + (e.lang || b) + "&rnd=" + Math.random() : void 0 !== e.likes ? k.src = "https://syndication.twitter.com/timeline/likes?callback=twitterFetcher.callback&dnt=false&screen_name=" + e.likes.screenName + "&suppress_response_codes=true&lang=" + (e.lang || b) + "&rnd=" + Math.random() : k.src = "https://cdn.syndication.twimg.com/widgets/timelines/" + e.id + "?&lang=" + (e.lang || b) + "&callback=twitterFetcher.callback&suppress_response_codes=true&rnd=" + Math.random(), t.appendChild(k)
                    }
                },
                callback: function(a) {
                    function w(e) {
                    ...
                    b.innerHTML = a.body, "undefined" == typeof b.getElementsByClassName && (u = !1);
                    var k = [],
                        _ = [],
                        x = [],
                        N = [],
                    ...
                    if (y)
                        for (; L > F;) A.push({
                            tweet: k[F].innerHTML,
                            author: _[F].innerHTML,
                            time: x[F].textContent,
                            image: s(N[F]),
                            rt: E[F],
                            tid: B[F],
                            permalinkURL: void 0 === I[F] ? "" : I[F].href
                        }), F++;
                    else
                        for (; L > F;) {
                            if ("string" != typeof p) {
                                var H = x[F].getAttribute("datetime"),
                                    R = new Date(x[F].getAttribute("datetime").replace(/-/g, "/").replace("T", " ").split("+")[0]),
                                    P = p(R, H);
                                if (x[F].setAttribute("aria-label", P), k[F].textContent)
                                    if (u) x[F].textContent = P;
                                    else {
                                        var U = document.createElement("p"),
                                            O = document.createTextNode(P);
                                        U.appendChild(O), U.setAttribute("aria-label", P), x[F] = U
                                    }
                                else x[F].textContent = P
                            }
                            var W = "";
                            r ? (v && (n(k[F]), m && n(_[F])), m && (W += '<div class="user">' + t(_[F].innerHTML) + "</div>"), W += '<p class="tweet">' + t(k[F].innerHTML) + "</p>", d && (W += T ? '<p class="timePosted"><a href="' + I[F] + '">' + x[F].getAttribute("aria-label") + "</a></p>" : '<p class="timePosted">' + x[F].getAttribute("aria-label") + "</p>")) : k[F].textContent ? (m && (W += '<p class="user">' + _[F].textContent + "</p>"), W += '<p class="tweet">' + k[F].textContent + "</p>", d && (W += '<p class="timePosted">' + x[F].textContent + "</p>")) : (m && (W += '<p class="user">' + _[F].textContent + "</p>"), W += '<p class="tweet">' + k[F].textContent + "</p>", d && (W += '<p class="timePosted">' + x[F].textContent + "</p>")), g && (W += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + B[F] + '" class="twitter_reply_icon"' + (v ? ' target="_blank" title="Reply">' : ">") + '</a><a href="https://twitter.com/intent/retweet?tweet_id=' + B[F] + '" class="twitter_retweet_icon"' + (v ? ' target="_blank" title="Retweet">' : ">") + '</a><a href="https://twitter.com/intent/favorite?tweet_id=' + B[F] + '" class="twitter_fav_icon"' + (v ? ' target="_blank" title="Like">' : ">") + "</a></p>"), f && void 0 !== N[F] && (W += '<div class="media"><img src="' + s(N[F]) + '" alt="Image from tweet" /></div>'), A.push(W), F++
                        }
                    e(A), c = !1, o.length > 0 && (C.fetch(o[0]), o.splice(0, 1))
                }
            };
